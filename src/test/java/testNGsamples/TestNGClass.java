...
public class TestNGClass {
   ...
   @Test
    public void verifyPageTitle_GetLinkSizeDina() throws InterruptedException {
    ...
    @Test
    public void verifyInfoReqform_sendRequestDina() {
    ...
    @Test
    public void verifyContUsLink_findILDina(){
